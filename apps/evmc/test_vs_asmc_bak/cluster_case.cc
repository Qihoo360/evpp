...
bool ClusterCase::Init(evpp::EventLoop * event) {
    ...
    mpc_ = new evmc::MemcacheClientPool("123.125.160.25:20099", FLAGS_thread_nums, FLAGS_timeout_ms);
//    mpc_ = new evmc::MemcacheClientPool("10.16.28.13:20099", FLAGS_thread_nums, FLAGS_timeout_ms);
    //mpc_ = new evmc::MemcacheClientPool("10.102.16.27:20011", FLAGS_thread_nums, FLAGS_timeout_ms);
    rt = mpc_->Start();
	assert(rt == true);
    return rt;
}
