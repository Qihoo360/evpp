...
pushd %{_builddir}/apps/evmc

cp libevmc.a          %{buildroot}/%{libpath}
popd

#devel files
pushd %{_builddir}/apps/evmc
mkdir -p %{buildroot}/%{includepath}/evmc
mkdir -p %{buildroot}/%{includepath}/evmc/libhashkit
mkdir -p %{buildroot}/%{includepath}/evmc/memcached
mkdir -p %{buildroot}/%{includepath}/evmc/rapidjson

cp -rf *.h  %{buildroot}/%{includepath}/evmc
cp -rf   ../../3rdparty/libhashkit/*.h %{buildroot}/%{includepath}/evmc/libhashkit
cp -rf   ../../3rdparty/memcached/*.h %{buildroot}/%{includepath}/evmc/memcached
cp -rf   ../../3rdparty/rapidjson/*.h %{buildroot}/%{includepath}/evmc/rapidjson
popd
